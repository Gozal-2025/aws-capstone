...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/gozal/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/gozal/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.cipyiw4oaafu.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'aws-capstones-gozal-blog' # please enter your s3 bucket name
